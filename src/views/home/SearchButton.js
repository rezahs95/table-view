      ...
      <div className='search-buton-wrapper'>
        ...
        <div className="download-button-container">
          ...
          <button className="download-button">
            <span className="button-text-real hidden">download</span>
            {/* Extra elements to perform the animations */}
            <span className="button-icon">
            <span className="button-linear-progress">
                <span className="button-linear-progress-bar"></span>
            </span>
            <svg className="button-icon-svg" viewBox="0 0 60 60">
                <path className="button-icon-path button-icon-path-square" d="M 20 40 l 0 -20 l 20 0 l 0 20 Z"></path>
                <path className="button-icon-path button-icon-path-line" d="M 40 20 l -20 20"></path>
            </svg>
        </span>
          </button>
          {/* Extra elements to perform the animations */}
          <svg className="border-svg" width="240px" height="100px" viewBox="0 0 240 100">
          ...
          <div className="button-progress-container">
            <svg className="button-svg">
              <path className="button-circular-progress"
                    d="M 50 50 m 0 -32.5 a 32.5 32.5 0 0 1 0 65 a 32.5 32.5 0 0 1 0 -65"></path>
            </svg>
            <span className="button-ball"></span>
          </div>
        </div>
