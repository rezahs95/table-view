...
const BackgroundColor = (props: backgroundColorProps) => {
  ...
  return (
      <svg aria-hidden="true" data-prefix="fas" data-icon="fill-drip" className="svg-inline--fa fa-fill-drip fa-w-18"
           role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" width={`${width}px`} height={`${height}px`}>
